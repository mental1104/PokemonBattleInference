"""
Date: 2025-12-13 15:13:18
Author: mental1104 mental1104@gmail.com
LastEditors: mental1104 mental1104@gmail.com
LastEditTime: 2025-12-13 16:13:46
"""
...
@pytest.mark.parametrize(
    "attacker_data, defenser_data, move, expect",
    [
        ...
        (
            ...
            Move(power=90, type=Type.FIRE, move_type=MoveType.special_move),
            ((63, 74), (21.0, 24.6)),
        ),
        # 50级炽焰咆哮虎 火推 50级败露球菇
        (
            ...
            Move(power=120, type=Type.FIRE, move_type=MoveType.physical_move),
            ((140, 168), (63.6, 76.3)),
        ),
...
def test_normal_damage(attacker_data, defenser_data, move, expect):
    ...
    for entity in (attacker_data, defenser_data):
        entity_stat = Pokemon.get_by_id(
            entity[0], session=mock_session_filter(entity[0])
        )
        pokemon_entity = director.construct_custom(
            ...
            species_strength=(
                ...
                entity_stat.attack,
                entity_stat.defense,
                entity_stat.special_attack,
                entity_stat.special_defense,
                entity_stat.speed,
            ),
            basepoint=entity[2],
