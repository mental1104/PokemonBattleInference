...
class ContestTypeNames(Base):
    ...
    flavor: Mapped[str] = mapped_column(Text, primary_key=True, nullable=False)
    color: Mapped[str] = mapped_column(Text, primary_key=True, nullable=False)

__all__ = ['ContestTypeNames']
