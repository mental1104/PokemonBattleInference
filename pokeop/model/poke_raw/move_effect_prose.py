...
class MoveEffectProse(Base):
    __tablename__ = 'move_effect_prose'
    move_effect_id: Mapped[int] = mapped_column(Integer, primary_key=True, nullable=False)
